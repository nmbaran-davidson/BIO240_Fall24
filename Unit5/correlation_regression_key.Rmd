...
```
This falls in the category of "near" normal It just barely fails the Shapiro-Wilks test, the qqplot shows there are no extreme outliers.
...
abline(0,0) 
```
The data are scattered evenly around the horizontal line, so the condition of constance of variability is met. 
