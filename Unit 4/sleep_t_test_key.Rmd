...
A: Because the p-value is greater than alpha (0.6417 > 0.05), we fail to reject the null hypothesis.  There is no difference between consecutive blood pressure readings.

(b): What is the interpretation of the 95% confidence interval?

A: We can be 95% confident that the true difference between consecutive blood pressure readings is between -0.797 and 1.289.
...
A: The tapply function shows the variances are very similar values.  The variance test confirms that to be true because the p-value of 0.9964 indicates no significant difference between the variances of both groups.  A two-sample t-test is appropriate.
...
A: Because p>alpha (i.e., 0.2008 > 0.05), we fail to reject the null hypothesis that the age at which individuals become diabetic differs between individuals that have smoked more or less than 100 cigarettes in their lifetime.

(c): What is the interpretation of the 95% confidence interval?

A: We are 95% confident that the average difference in the age of becoming diabetic between individuals that have and haven't smoked 100 cigarettes in their lifetimes is between -32.68 and 7.94 years of age.  This aligns with the result of our hypothesis test.
